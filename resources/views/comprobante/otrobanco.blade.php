 ...
 <main>
  <section class="container mt-5">
   <a href="{{route('perfil.index')}}">Regresar</a><br><br>
    <h1 class="text-rosa text-center">Otro banco</h1><br>
    ...
    <div class="input-div row">
        <div class="col-12 col-md-6 my-3">
         ...
         <div class="col-12 col-md-6 my-3">
            <label class="col" for="">Banco</label>
           <input type="text" name="banco" id="">
          </div>
      </div>
     <div class="input-div row">
       <div class="col-12 col-md-6 my-3">
          <label for="name" class="form-label">Guía CIE o No. Rastreo</label>
      ...
      <div class="input-div row">
        ...
        <input type="hidden" name="metodo_pago" value="otroBanco">
